...
class _HomeLoginState extends State<HomeLogin> {
          ...
          child: ListView(
            children: [
              Container(
                ...
                child: bodyHomeLogin(widthOfScreen),
              ),
            ],
          ),
        ),
  ...
  Widget bodyHomeLogin(double width){
    return Stack(
      children: [
        Positioned(
          top: 20.0,
      ...
      child: Column(
        children: <Widget>[
          ...
          ResponsiveWidget.isSmallScreen(context)
            ...
            child: boutonConnexion(270.0),
          )
              : Center(child: boutonConnexion(270.0),),
          //Text Inscription
          ResponsiveWidget.isSmallScreen(context)
              ? Container(
  ...
  Widget boutonConnexion(double width){
    return Container(
      width: width,
